...
class ModalKey<T> extends ValueKey<T> {
  const ModalKey(T value) : super(value);
...
///
/// The [OverlayNotificationEntry] associated with [TransientKey] will be dismiss immediately
/// when next [OverlayNotificationEntry] showing by [showOverlay] with the same key.
///
