...
class _AnimatedOverlay extends StatefulWidget {
  ...
  final OverlayNotificationState overlayNotificationState;
  ...
  const _AnimatedOverlay({
    ...
    required this.overlayNotificationState,
...
class _AnimatedOverlayState extends State<_AnimatedOverlay>
  ...
  void initState() {
    ...
    super.initState();
    final overlayEntry =
        widget.overlayNotificationState.getEntry(key: widget.overlayKey);
